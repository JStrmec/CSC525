...
class TestSemanticEncoder(unittest.TestCase):
    ...
    def test_query_prefix(self):
        ...
        result = self.model.encode(
            input_dict={"text": input_text, "dataType": "query", "quantize": False}
        )
    ...
    def test_passage_prefix(self):
        ...
        result = self.model.encode(
            input_dict={"text": input_text, "dataType": "passage", "quantize": False}
        )
        self.assertIn("vector", result)
        self.assertIsInstance(result["vector"], list)

    def test_quantized_output(self):
        input_text = "Quantize this text"
        result = self.model.encode(
            input_dict={"text": input_text, "dataType": "query", "quantize": True}
        )
        self.assertIn("vector", result)
        ...
        self.assertTrue(
            all(isinstance(x, int) and 0 <= x <= 255 for x in vector),
            "Quantized vector must be uint8 in [0,255]",
        )

    def test_invalid_input(self):
        result = self.model.encode(input_dict={"dataType": "query", "quantize": False})
    ...
    def test_encoding_similarity(self):
        ...
        # Predict vector
        result = self.model.encode(
            input_dict={"text": input_text, "dataType": None, "quantize": False}
        )
